...
import com.example.gamudaland.Adapter.CanHo.Muabancanho_Adapter;
...
public class MuaBanCanHo_Fragment extends Fragment {
    private MuabancanhoDAO muabancanhoDAO;
    private RecyclerView recyclerView;
    AlertDialog alertDialog;
    private Muabancanho_Adapter muabanLoDat_adapter;
    private List<Muabancanho> muabancanhos;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.muaban_canho_fragment, container, false);

        recyclerView = view.findViewById(R.id.muabancanho_rcview);
        floatingActionButton = view.findViewById(R.id.floatingActionButton2);

        muabancanho = new Muabancanho();

        muabancanhoDAO = new MuabancanhoDAO(getActivity());
                ...
                ok1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (tittle.equals("")) {
                            ...
                            muabancanho.setMamuabancanho(String.valueOf(i1));
                            ...
                            if (resurt > 0) {
                                ...
                                muabancanhos = muabancanhoDAO.getAll();
                                muabanLoDat_adapter = new Muabancanho_Adapter(muabancanhos, getActivity());
